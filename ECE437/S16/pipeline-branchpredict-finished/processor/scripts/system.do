...
add wave -noupdate -group {Control Unit} /system_tb/DUT/CPU/DP/cuif/imemload
add wave -noupdate -group {Control Unit} /system_tb/DUT/CPU/DP/cuif/j
...
add wave -noupdate -group {Control Unit} /system_tb/DUT/CPU/DP/cuif/ShiftOp
add wave -noupdate -group {Control Unit} /system_tb/DUT/CPU/DP/cuif/lui
add wave -noupdate -group {Control Unit} /system_tb/DUT/CPU/DP/cuif/dR_REQ
add wave -noupdate -group {Control Unit} /system_tb/DUT/CPU/DP/cuif/dW_REQ
...
add wave -noupdate -expand -group ALU -radix decimal /system_tb/DUT/CPU/DP/aluif/portB
...
add wave -noupdate /system_tb/DUT/CPU/DP/btbhit
add wave -noupdate /system_tb/DUT/CPU/DP/jump_add
add wave -noupdate -expand -group BTB /system_tb/DUT/CPU/DP/branch_address
add wave -noupdate -expand -group BTB /system_tb/DUT/CPU/DP/pc_plus_4_M
add wave -noupdate -expand -group BTB -expand -subitemconfig {/system_tb/DUT/CPU/DP/btbframes.frameblocks -expand} /system_tb/DUT/CPU/DP/btbframes
add wave -noupdate /system_tb/DUT/CPU/DP/does_exist
add wave -noupdate -expand -group {opcodes - BTB related} /system_tb/DUT/CPU/DP/op_D
add wave -noupdate -expand -group {opcodes - BTB related} /system_tb/DUT/CPU/DP/op_EX
add wave -noupdate -expand -group {opcodes - BTB related} /system_tb/DUT/CPU/DP/op_M
add wave -noupdate -expand -group {opcodes - BTB related} /system_tb/DUT/CPU/DP/op_WB
add wave -noupdate /system_tb/DUT/CPU/DP/pc_next
add wave -noupdate /system_tb/DUT/CPU/DP/pc
add wave -noupdate -expand -group Predict-values /system_tb/DUT/CPU/DP/predicted
add wave -noupdate -expand -group Predict-values /system_tb/DUT/CPU/DP/predicted_D
add wave -noupdate -expand -group Predict-values /system_tb/DUT/CPU/DP/predicted_EX
add wave -noupdate -expand -group Predict-values /system_tb/DUT/CPU/DP/predicted_M
add wave -noupdate /system_tb/DUT/CPU/DP/zero_M
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/CLK
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/nRST
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/pc
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/btbframes
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/btbhit
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/jump_add
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/predicted
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/tag_to_match
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/get_index
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/is_valid
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/tag_match
add wave -noupdate -expand -group {BTB F-stage module} /system_tb/DUT/CPU/DP/BTB/found
...
WaveRestoreCursors {{Cursor 1} {6736301 ps} 0}
...
update
WaveRestoreZoom {5958472 ps} {6979657 ps}
