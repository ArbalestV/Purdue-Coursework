# encoding: utf-8
# module cups
# from /usr/lib64/python2.6/site-packages/cups.so
# by generator 1.136
# no doc
# no imports
...
class Connection(object):
    ...
    def createSubscription(self, uri): # real signature unknown; restored from __doc__
        """
    ...
    def getJobs(self, which_jobs='not-completed', my_jobs=False, limit=-1, first_job_id=-1): # real signature unknown; restored from __doc__
        """
...
class HTTPError(Exception):
    ...
    """
    def __init__(self, status): # real signature unknown; restored from __doc__
        pass
...
class IPPError(Exception):
    ...
    """
    def __init__(self, status, description): # real signature unknown; restored from __doc__
        pass
