...
# from /usr/lib64/python2.6/site-packages/PyQt4/QtAssistant.so
# by generator 1.136
# no doc
...
class QAssistantClient(__PyQt4_QtCore.QObject):
    ...
    def closeAssistant(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def openAssistant(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def showPage(self, *args, **kwargs): # real signature unknown
        pass
