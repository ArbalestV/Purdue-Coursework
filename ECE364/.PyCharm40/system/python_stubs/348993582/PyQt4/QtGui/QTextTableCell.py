...
class QTextTableCell(): # skipped bases: <type 'sip.simplewrapper'>
    ...
    def firstCursorPosition(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def lastCursorPosition(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def tableCellFormatIndex(self, *args, **kwargs): # real signature unknown
        pass
