...
class QTextInlineObject(): # skipped bases: <type 'sip.simplewrapper'>
    ...
    def setAscent(self, *args, **kwargs): # real signature unknown
        pass

    def setDescent(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def textPosition(self, *args, **kwargs): # real signature unknown
        pass
