...
class QLibrary(QObject):
    ...
    def isLibrary(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def loadHints(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setFileNameAndVersion(self, *args, **kwargs): # real signature unknown
        pass

    def setLoadHints(self, *args, **kwargs): # real signature unknown
        pass
