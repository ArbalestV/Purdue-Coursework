...
# from /usr/lib64/python2.6/site-packages/gtk-2.0/gnomevfs/_gnomevfs.so
# by generator 1.136
# no doc
...
class Volume(__gobject__gobject.GObject):
    """
    ...
    def get_filesystem_type(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def get_volume_type(self, *args, **kwargs): # real signature unknown
        pass

    def handles_trash(self, *args, **kwargs): # real signature unknown
        pass

    def is_mounted(self, *args, **kwargs): # real signature unknown
        pass

    def is_read_only(self, *args, **kwargs): # real signature unknown
        pass
