...
class PluginFeature(__gst.Object):
    """
    ...
    Signals from GObject:
      notify (GParam)
    """
    def check_version(self, *args, **kwargs): # real signature unknown
        pass

    def get_name(self, *args, **kwargs): # real signature unknown
        pass

    def get_rank(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_rank(self, *args, **kwargs): # real signature unknown
        pass
