# encoding: utf-8
# module egg.trayicon
# from /usr/lib64/python2.6/site-packages/gtk-2.0/egg/trayicon.so
# by generator 1.136
# no doc
...
def egg_tray_icon_new_for_screen(*args, **kwargs): # real signature unknown
    pass

# classes

class TrayIcon(__gtk.Plug):
    """
    Object EggTrayIcon
    
    Properties from EggTrayIcon:
    ...
    Signals from GObject:
      notify (GParam)
    """
    def cancel_message(self, *args, **kwargs): # real signature unknown
        pass

    def send_message(self, *args, **kwargs): # real signature unknown
        pass
