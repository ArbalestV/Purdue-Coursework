...
class AlgorithmID(object):
    ...
    id_oid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """algorithm id OID as SecItem"""

    id_str = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """algorithm id as string description"""

    id_tag = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
