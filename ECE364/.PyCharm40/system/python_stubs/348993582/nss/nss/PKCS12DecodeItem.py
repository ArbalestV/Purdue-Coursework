...
class PKCS12DecodeItem(object):
    ...
    friendly_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    shroud_algorithm_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """shroud algorithm id certificate as AlgorithmID object, or None if does not exist"""

    signed_cert_der = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
