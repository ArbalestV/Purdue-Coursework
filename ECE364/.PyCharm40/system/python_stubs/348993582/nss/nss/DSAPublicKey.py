...
class DSAPublicKey(object):
    ...
    pqg_params = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """DSA P,Q,G params as a KEYPQGParams object"""

    public_value = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """DSA public_value"""
