...
class PublicKey(object):
    ...
    dsa = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    key_type_str = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """key type as a string"""

    rsa = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """RSA key as a RSAPublicKey object"""
