...
class InitParameters(object):
    ...
    crypto_slot_description = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    crypto_token_description = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    db_slot_description = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    db_token_description = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fips_slot_description = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fips_token_description = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    library_description = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    manufacturer_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """manufacturer id (max 32 chars)"""

    min_password_len = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """minimum password length"""

    password_required = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
