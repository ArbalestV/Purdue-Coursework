...
class ORB(object):
    # no doc
    def list_initial_services(self, *args, **kwargs): # real signature unknown
        pass

    def object_to_string(self, *args, **kwargs): # real signature unknown
        pass

    def perform_work(self, *args, **kwargs): # real signature unknown
        pass

    def resolve_initial_references(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def string_to_object(self, *args, **kwargs): # real signature unknown
        pass

    def work_pending(self, *args, **kwargs): # real signature unknown
        pass
    ...
    InvalidName = None # (!) real value is ''
