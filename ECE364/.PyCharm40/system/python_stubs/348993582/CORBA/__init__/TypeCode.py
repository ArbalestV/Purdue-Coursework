...
class TypeCode(object):
    ...
    default_index = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    digits = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    discriminator = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    recurse_depth = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    repo_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    scale = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    sublabels = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    subnames = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    subtypes = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    sub_parts = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    BadKind = None # (!) real value is ''
    Bounds = None # (!) real value is ''
