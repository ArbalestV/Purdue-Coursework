...
class Box(Container, Orientable):
    ...
    def pack_end_defaults(self, *args, **kwargs): # real signature unknown
        pass

    def pack_start(self, *args, **kwargs): # real signature unknown
        pass

    def pack_start_defaults(self, *args, **kwargs): # real signature unknown
        pass

    def query_child_packing(self, *args, **kwargs): # real signature unknown
        pass

    def reorder_child(self, *args, **kwargs): # real signature unknown
        pass

    def set_child_packing(self, *args, **kwargs): # real signature unknown
        pass
