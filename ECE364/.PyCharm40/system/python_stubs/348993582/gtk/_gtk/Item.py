...
class Item(Bin):
    ...
    @classmethod
    def do_deselect(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_select(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_toggle(cls, *args, **kwargs): # real signature unknown
        pass
