...
class FontSelectionDialog(Dialog):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_apply_button(self, *args, **kwargs): # real signature unknown
        pass

    def get_cancel_button(self, *args, **kwargs): # real signature unknown
        pass

    def get_font(self, *args, **kwargs): # real signature unknown
        pass

    def get_font_name(self, *args, **kwargs): # real signature unknown
        pass

    def get_ok_button(self, *args, **kwargs): # real signature unknown
        pass

    def get_preview_text(self, *args, **kwargs): # real signature unknown
        pass

    def set_font_name(self, *args, **kwargs): # real signature unknown
        pass

    def set_preview_text(self, *args, **kwargs): # real signature unknown
        pass
    ...
    apply_button = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    cancel_button = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fontsel = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
