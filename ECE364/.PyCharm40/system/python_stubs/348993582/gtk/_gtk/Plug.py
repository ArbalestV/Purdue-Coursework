...
class Plug(Window):
    ...
    """
    @classmethod
    def do_embedded(cls, *args, **kwargs): # real signature unknown
        pass

    def get_embedded(self, *args, **kwargs): # real signature unknown
        pass

    def get_id(self, *args, **kwargs): # real signature unknown
        pass

    def get_socket_window(self, *args, **kwargs): # real signature unknown
        pass
