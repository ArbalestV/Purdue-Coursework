...
class FontSelection(VBox):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_face(self, *args, **kwargs): # real signature unknown
        pass

    def get_face_list(self, *args, **kwargs): # real signature unknown
        pass

    def get_family(self, *args, **kwargs): # real signature unknown
        pass

    def get_family_list(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def get_preview_entry(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def get_size_entry(self, *args, **kwargs): # real signature unknown
        pass

    def get_size_list(self, *args, **kwargs): # real signature unknown
        pass
