...
class MenuToolButton(ToolButton):
    ...
    """
    @classmethod
    def do_show_menu(cls, *args, **kwargs): # real signature unknown
        pass

    def get_menu(self, *args, **kwargs): # real signature unknown
        pass

    def set_arrow_tooltip(self, *args, **kwargs): # real signature unknown
        pass

    def set_arrow_tooltip_markup(self, *args, **kwargs): # real signature unknown
        pass

    def set_arrow_tooltip_text(self, *args, **kwargs): # real signature unknown
        pass
