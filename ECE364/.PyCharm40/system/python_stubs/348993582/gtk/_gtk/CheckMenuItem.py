...
class CheckMenuItem(MenuItem):
    ...
    """
    @classmethod
    def do_draw_indicator(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    def get_draw_as_radio(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_draw_as_radio(self, *args, **kwargs): # real signature unknown
        pass

    def set_inconsistent(self, *args, **kwargs): # real signature unknown
        pass

    def set_show_toggle(self, *args, **kwargs): # real signature unknown
        pass
