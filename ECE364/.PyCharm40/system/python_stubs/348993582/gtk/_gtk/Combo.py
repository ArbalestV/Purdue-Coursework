...
class Combo(HBox):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def disable_activate(self, *args, **kwargs): # real signature unknown
        pass

    def set_case_sensitive(self, *args, **kwargs): # real signature unknown
        pass

    def set_item_string(self, *args, **kwargs): # real signature unknown
        pass

    def set_popdown_strings(self, *args, **kwargs): # real signature unknown
        pass

    def set_use_arrows(self, *args, **kwargs): # real signature unknown
        pass

    def set_use_arrows_always(self, *args, **kwargs): # real signature unknown
        pass

    def set_value_in_list(self, *args, **kwargs): # real signature unknown
        pass
