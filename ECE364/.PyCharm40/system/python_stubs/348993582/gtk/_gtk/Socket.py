...
class Socket(Container):
    ...
    @classmethod
    def do_plug_added(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_plug_removed(cls, *args, **kwargs): # real signature unknown
        pass

    def get_id(self, *args, **kwargs): # real signature unknown
        pass

    def get_plug_window(self, *args, **kwargs): # real signature unknown
        pass

    def steal(self, *args, **kwargs): # real signature unknown
        pass
