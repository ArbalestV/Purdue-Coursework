...
class MenuItem(Item, Activatable):
    """
    Object GtkMenuItem
    ...
    @classmethod
    def do_activate_item(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_toggle_size_allocate(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    def get_right_justified(self, *args, **kwargs): # real signature unknown
        pass

    def get_submenu(self, *args, **kwargs): # real signature unknown
        pass

    def get_use_underline(self, *args, **kwargs): # real signature unknown
        pass

    def remove_submenu(self, *args, **kwargs): # real signature unknown
        pass

    def right_justify(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_right_justified(self, *args, **kwargs): # real signature unknown
        pass

    def set_submenu(self, *args, **kwargs): # real signature unknown
        pass

    def set_use_underline(self, *args, **kwargs): # real signature unknown
        pass

    def toggle_size_allocate(self, *args, **kwargs): # real signature unknown
        pass

    def toggle_size_request(self, *args, **kwargs): # real signature unknown
        pass
