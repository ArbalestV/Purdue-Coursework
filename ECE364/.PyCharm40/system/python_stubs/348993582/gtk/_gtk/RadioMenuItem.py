...
class RadioMenuItem(CheckMenuItem):
    ...
    """
    @classmethod
    def do_group_changed(cls, *args, **kwargs): # real signature unknown
        pass

    def get_group(self, *args, **kwargs): # real signature unknown
        pass

    def new_from_widget(self, *args, **kwargs): # real signature unknown
        pass

    def new_with_label_from_widget(self, *args, **kwargs): # real signature unknown
        pass

    def new_with_mnemonic_from_widget(self, *args, **kwargs): # real signature unknown
        pass
