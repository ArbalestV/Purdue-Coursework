...
class ButtonBox(Box):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_child_ipadding(self, *args, **kwargs): # real signature unknown
        pass

    def get_child_secondary(self, *args, **kwargs): # real signature unknown
        pass

    def get_child_size(self, *args, **kwargs): # real signature unknown
        pass

    def get_layout(self, *args, **kwargs): # real signature unknown
        pass

    def set_child_ipadding(self, *args, **kwargs): # real signature unknown
        pass

    def set_child_secondary(self, *args, **kwargs): # real signature unknown
        pass

    def set_child_size(self, *args, **kwargs): # real signature unknown
        pass
