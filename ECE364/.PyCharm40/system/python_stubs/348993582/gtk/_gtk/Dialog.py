...
class Dialog(Window):
    ...
    def add_button(self, *args, **kwargs): # real signature unknown
        pass

    def add_buttons(self, *args, **kwargs): # real signature unknown
        pass
    ...
    @classmethod
    def do_response(cls, *args, **kwargs): # real signature unknown
        pass

    def get_action_area(self, *args, **kwargs): # real signature unknown
        pass

    def get_content_area(self, *args, **kwargs): # real signature unknown
        pass

    def get_has_separator(self, *args, **kwargs): # real signature unknown
        pass

    def get_response_for_widget(self, *args, **kwargs): # real signature unknown
        pass

    def response(self, *args, **kwargs): # real signature unknown
        pass

    def run(self, *args, **kwargs): # real signature unknown
        pass

    def set_alternative_button_order(self, *args, **kwargs): # real signature unknown
        pass

    def set_default_response(self, *args, **kwargs): # real signature unknown
        pass

    def set_has_separator(self, *args, **kwargs): # real signature unknown
        pass

    def set_response_sensitive(self, *args, **kwargs): # real signature unknown
        pass
