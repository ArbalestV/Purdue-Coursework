...
class CellView(Widget, CellLayout):
    """
    Object GtkCellView
    ...
    def get_displayed_row(self, *args, **kwargs): # real signature unknown
        pass

    def get_model(self, *args, **kwargs): # real signature unknown
        pass

    def get_size_of_row(self, *args, **kwargs): # real signature unknown
        pass

    def set_background_color(self, *args, **kwargs): # real signature unknown
        pass

    def set_displayed_row(self, *args, **kwargs): # real signature unknown
        pass
