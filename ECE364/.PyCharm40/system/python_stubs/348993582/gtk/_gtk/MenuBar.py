...
class MenuBar(MenuShell):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_child_pack_direction(self, *args, **kwargs): # real signature unknown
        pass

    def get_pack_direction(self, *args, **kwargs): # real signature unknown
        pass

    def set_child_pack_direction(self, *args, **kwargs): # real signature unknown
        pass

    def set_pack_direction(self, *args, **kwargs): # real signature unknown
        pass
