...
class AccelLabel(Label):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def accelerator_width(self, *args, **kwargs): # real signature unknown
        pass

    def get_accel_widget(self, *args, **kwargs): # real signature unknown
        pass

    def get_accel_width(self, *args, **kwargs): # real signature unknown
        pass

    def refetch(self, *args, **kwargs): # real signature unknown
        pass

    def set_accel_closure(self, *args, **kwargs): # real signature unknown
        pass

    def set_accel_widget(self, *args, **kwargs): # real signature unknown
        pass
