...
class Progress(Widget):
    ...
    @classmethod
    def do_act_mode_enter(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    def get_current_percentage(self, *args, **kwargs): # real signature unknown
        pass

    def get_current_text(self, *args, **kwargs): # real signature unknown
        pass

    def get_percentage_from_value(self, *args, **kwargs): # real signature unknown
        pass

    def get_text_from_value(self, *args, **kwargs): # real signature unknown
        pass

    def get_value(self, *args, **kwargs): # real signature unknown
        pass

    def set_activity_mode(self, *args, **kwargs): # real signature unknown
        pass

    def set_adjustment(self, *args, **kwargs): # real signature unknown
        pass

    def set_format_string(self, *args, **kwargs): # real signature unknown
        pass

    def set_percentage(self, *args, **kwargs): # real signature unknown
        pass

    def set_show_text(self, *args, **kwargs): # real signature unknown
        pass

    def set_text_alignment(self, *args, **kwargs): # real signature unknown
        pass
