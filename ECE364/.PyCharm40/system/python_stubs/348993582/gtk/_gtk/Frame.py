...
class Frame(Bin):
    ...
    """
    @classmethod
    def do_compute_child_allocation(cls, *args, **kwargs): # real signature unknown
        pass

    def get_label(self, *args, **kwargs): # real signature unknown
        pass

    def get_label_align(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_label_align(self, *args, **kwargs): # real signature unknown
        pass
