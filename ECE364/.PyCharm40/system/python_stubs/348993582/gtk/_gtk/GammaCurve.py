...
class GammaCurve(VBox):
    ...
    gamma_dialog = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    gamma_text = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
