...
class ScaleButton(Button, Orientable):
    ...
    def get_minus_button(self, *args, **kwargs): # real signature unknown
        pass

    def get_orientation(self, *args, **kwargs): # real signature unknown
        pass

    def get_plus_button(self, *args, **kwargs): # real signature unknown
        pass

    def get_popup(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_icons(self, *args, **kwargs): # real signature unknown
        pass
