...
class Statusbar(HBox):
    ...
    Properties from GtkStatusbar:
      has-resize-grip -> gboolean: Has Resize Grip
    ...
    """
    @classmethod
    def do_text_popped(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_text_pushed(cls, *args, **kwargs): # real signature unknown
        pass

    def get_context_id(self, *args, **kwargs): # real signature unknown
        pass

    def get_has_resize_grip(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def remove_message(self, *args, **kwargs): # real signature unknown
        pass

    def set_has_resize_grip(self, *args, **kwargs): # real signature unknown
        pass
