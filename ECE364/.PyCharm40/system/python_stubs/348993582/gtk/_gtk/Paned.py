...
class Paned(Container, Orientable):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def add1(self, *args, **kwargs): # real signature unknown
        pass

    def add2(self, *args, **kwargs): # real signature unknown
        pass

    def compute_position(self, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_accept_position(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_cancel_position(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_cycle_child_focus(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_cycle_handle_focus(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_move_handle(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_toggle_handle_focus(cls, *args, **kwargs): # real signature unknown
        pass

    def get_child1(self, *args, **kwargs): # real signature unknown
        pass

    def get_child2(self, *args, **kwargs): # real signature unknown
        pass

    def get_position(self, *args, **kwargs): # real signature unknown
        pass

    def pack1(self, *args, **kwargs): # real signature unknown
        pass

    def pack2(self, *args, **kwargs): # real signature unknown
        pass
