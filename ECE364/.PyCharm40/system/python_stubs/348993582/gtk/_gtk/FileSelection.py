...
class FileSelection(Dialog):
    ...
    Properties from GtkFileSelection:
      show-fileops -> gboolean: Show file operations
    ...
    def get_selections(self, *args, **kwargs): # real signature unknown
        pass

    def get_select_multiple(self, *args, **kwargs): # real signature unknown
        pass

    def hide_fileop_buttons(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def show_fileop_buttons(self, *args, **kwargs): # real signature unknown
        pass
    ...
    button_area = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    cancel_button = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    dir_list = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fileop_c_dir = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fileop_del_file = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fileop_dialog = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fileop_entry = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fileop_file = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    fileop_ren_file = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    file_list = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    help_button = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    history_menu = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    history_pulldown = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    main_vbox = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    ok_button = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    selection_entry = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    selection_text = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
