...
class Ruler(Widget, Orientable):
    """
    Object GtkRuler
    
    Properties from GtkRuler:
      lower -> gdouble: Lower
    ...
    """
    @classmethod
    def do_draw_pos(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_draw_ticks(cls, *args, **kwargs): # real signature unknown
        pass

    def draw_pos(self, *args, **kwargs): # real signature unknown
        pass

    def draw_ticks(self, *args, **kwargs): # real signature unknown
        pass

    def get_metric(self, *args, **kwargs): # real signature unknown
        pass

    def get_range(self, *args, **kwargs): # real signature unknown
        pass

    def set_metric(self, *args, **kwargs): # real signature unknown
        pass
