...
class OptionMenu(Button):
    ...
    Signals from GtkOptionMenu:
      changed ()
    
    Properties from GtkOptionMenu:
      menu -> GtkMenu: Menu
        The menu of options
    ...
    def remove_menu(self, *args, **kwargs): # real signature unknown
        pass

    def set_history(self, *args, **kwargs): # real signature unknown
        pass
