...
class EventBox(Bin):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_above_child(self, *args, **kwargs): # real signature unknown
        pass

    def get_visible_window(self, *args, **kwargs): # real signature unknown
        pass

    def set_above_child(self, *args, **kwargs): # real signature unknown
        pass

    def set_visible_window(self, *args, **kwargs): # real signature unknown
        pass
