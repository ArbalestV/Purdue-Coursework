...
# from /usr/lib64/python2.6/site-packages/numpy/core/multiarray.so
# by generator 1.136
# no doc
...
def array(p_object, dtype=None, copy=True, order=None, subok=False, ndmin=True): # real signature unknown; restored from __doc__
    """
...
def can_cast(fromtype, totype): # real signature unknown; restored from __doc__
    """
...
class ndarray(object):
    ...
    def getfield(self, dtype, offset): # real signature unknown; restored from __doc__
        """
    ...
    def resize(self, new_shape, refcheck=True, order=False): # real signature unknown; restored from __doc__
        """
    ...
    def searchsorted(self, v, side='left'): # real signature unknown; restored from __doc__
        """
