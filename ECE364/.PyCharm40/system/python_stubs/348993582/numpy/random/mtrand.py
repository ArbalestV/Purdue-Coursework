...
# from /usr/lib64/python2.6/site-packages/numpy/random/mtrand.so
# by generator 1.136
# no doc

# imports
import numpy as np # /usr/lib64/python2.6/site-packages/numpy/__init__.pyc
...
def randn(*args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    randn([d1, ..., dn])
...
def vonmises(mu=0.0, kappa=1.0, size=None): # real signature unknown; restored from __doc__
    """
...
class RandomState(object):
    ...
    def randn(self, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """
        randn([d1, ..., dn])
    ...
    def vonmises(self, mu=0.0, kappa=1.0, size=None): # real signature unknown; restored from __doc__
        """
        vonmises(mu=0.0, kappa=1.0, size=None)
