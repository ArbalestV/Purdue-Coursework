...
# from /usr/lib64/python2.6/site-packages/lxml/objectify.so
# by generator 1.136
"""
...
class NumberElement(ObjectifiedDataElement):
    ...
    def __hex__(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def __oct__(self, *args, **kwargs): # real signature unknown
        pass
...
class ObjectifyElementClassLookup(__lxml_etree.ElementClassLookup):
    ...
    """
    def __init__(self, tree_class=None, empty_data_class=None): # real signature unknown; restored from __doc__
        pass
