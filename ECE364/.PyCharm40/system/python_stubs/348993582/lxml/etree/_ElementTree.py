...
class _ElementTree(object):
    ...
    def write(self, file, encoding=None, method="xml", pretty_print=False, xml_declaration=None, with_tail=True, standalone=None, compression=0): # real signature unknown; restored from __doc__
        """
