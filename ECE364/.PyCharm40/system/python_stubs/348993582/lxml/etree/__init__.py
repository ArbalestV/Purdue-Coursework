...
def tostring(element_or_tree, encoding=None, method="xml", xml_declaration=None, pretty_print=False, with_tail=True, standalone=None): # real signature unknown; restored from __doc__
    """
...
def tounicode(element_or_tree, method="xml", pretty_print=False, with_tail=True): # real signature unknown; restored from __doc__
    """
...
def XMLDTDID(text): # real signature unknown; restored from __doc__
    """
    XMLDTDID(text)
...
def XMLID(text): # real signature unknown; restored from __doc__
    """
    XMLID(text)
