...
class FileEntry(__gtk.VBox, __gtk.Editable):
    """
    Object GnomeFileEntry
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_directory_entry(self, *args, **kwargs): # real signature unknown
        pass

    def get_full_path(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_default_path(self, *args, **kwargs): # real signature unknown
        pass

    def set_directory(self, *args, **kwargs): # real signature unknown
        pass

    def set_directory_entry(self, *args, **kwargs): # real signature unknown
        pass
