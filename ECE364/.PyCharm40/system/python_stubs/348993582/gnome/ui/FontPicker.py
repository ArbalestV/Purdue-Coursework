...
class FontPicker(__gtk.Button):
    """
    Object GnomeFontPicker
    
    Signals from GnomeFontPicker:
      font-set (gchararray)
    
    Properties from GnomeFontPicker:
      title -> gchararray: Title
        The title of the selection dialog box
      mode -> GnomeFontPickerMode: Mode
      ...
      use-font-in-label -> gboolean: Use font in label
        Use font in the label in font info mode
      label-font-size -> gint: Font size for label
    ...
    Signals from GObject:
      notify (GParam)
    """
    def fi_set_show_size(self, *args, **kwargs): # real signature unknown
        pass

    def fi_set_use_font_in_label(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def uw_get_widget(self, *args, **kwargs): # real signature unknown
        pass

    def uw_set_widget(self, *args, **kwargs): # real signature unknown
        pass
