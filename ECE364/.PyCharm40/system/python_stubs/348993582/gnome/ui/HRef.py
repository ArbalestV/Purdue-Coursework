...
class HRef(__gtk.Button):
    """
    Object GnomeHRef
    
    Properties from GnomeHRef:
      url -> gchararray: URL
    ...
    def get_url(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_url(self, *args, **kwargs): # real signature unknown
        pass
