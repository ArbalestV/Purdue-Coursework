...
class AppBar(__gtk.HBox):
    """
    Object GnomeAppBar
    
    Signals from GnomeAppBar:
      user-response ()
      clear-prompt ()
    
    Properties from GnomeAppBar:
      has-progress -> gboolean: Has Progress
        Create a progress widget.
      has-status -> gboolean: Has Status
    ...
    Signals from GObject:
      notify (GParam)
    """
    def clear_prompt(self, *args, **kwargs): # real signature unknown
        pass

    def clear_stack(self, *args, **kwargs): # real signature unknown
        pass

    def get_progress(self, *args, **kwargs): # real signature unknown
        pass

    def get_response(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_progress_percentage(self, *args, **kwargs): # real signature unknown
        pass

    def set_prompt(self, *args, **kwargs): # real signature unknown
        pass
