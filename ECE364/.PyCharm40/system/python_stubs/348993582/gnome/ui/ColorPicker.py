...
class ColorPicker(__gtk.Button):
    """
    Object GnomeColorPicker
    
    Signals from GnomeColorPicker:
      color-set (guint, guint, guint, guint)
    
    Properties from GnomeColorPicker:
      dither -> gboolean: dither
    ...
    def get_use_alpha(self, *args, **kwargs): # real signature unknown
        pass

    def set_d(self, *args, **kwargs): # real signature unknown
        pass

    def set_dither(self, *args, **kwargs): # real signature unknown
        pass

    def set_i16(self, *args, **kwargs): # real signature unknown
        pass

    def set_i8(self, *args, **kwargs): # real signature unknown
        pass

    def set_title(self, *args, **kwargs): # real signature unknown
        pass

    def set_use_alpha(self, *args, **kwargs): # real signature unknown
        pass
