...
class Druid(__gtk.Container):
    """
    Object GnomeDruid
    
    Signals from GnomeDruid:
      cancel ()
      help ()
    
    Properties from GnomeDruid:
      show-finish -> gboolean: Show Finish
        Show the 'Finish' button instead of the 'Next' button
      show-help -> gboolean: Show Help
    ...
    def set_buttons_sensitive(self, *args, **kwargs): # real signature unknown
        pass

    def set_page(self, *args, **kwargs): # real signature unknown
        pass

    def set_show_finish(self, *args, **kwargs): # real signature unknown
        pass

    def set_show_help(self, *args, **kwargs): # real signature unknown
        pass
