...
class IconEntry(__gtk.VBox):
    """
    Object GnomeIconEntry
    
    Signals from GnomeIconEntry:
      changed ()
      browse ()
    
    Properties from GnomeIconEntry:
    ...
    def pick_dialog(self, *args, **kwargs): # real signature unknown
        pass

    def set_browse_dialog_title(self, *args, **kwargs): # real signature unknown
        pass
