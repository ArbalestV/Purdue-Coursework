...
class IconSelection(__gtk.VBox):
    """
    Object GnomeIconSelection
    ...
    Signals from GObject:
      notify (GParam)
    """
    def add_defaults(self, *args, **kwargs): # real signature unknown
        pass

    def add_directory(self, *args, **kwargs): # real signature unknown
        pass

    def clear(self, *args, **kwargs): # real signature unknown
        pass

    def get_box(self, *args, **kwargs): # real signature unknown
        pass

    def get_gil(self, *args, **kwargs): # real signature unknown
        pass
