...
class App(__gtk.Window):
    """
    Object GnomeApp
    
    Properties from GnomeApp:
    ...
    Signals from GObject:
      notify (GParam)
    """
    def add_docked(self, *args, **kwargs): # real signature unknown
        pass

    def add_dock_item(self, *args, **kwargs): # real signature unknown
        pass

    def add_toolbar(self, *args, **kwargs): # real signature unknown
        pass

    def enable_layout_config(self, *args, **kwargs): # real signature unknown
        pass

    def error(self, *args, **kwargs): # real signature unknown
        pass

    def flash(self, *args, **kwargs): # real signature unknown
        pass

    def get_dock(self, *args, **kwargs): # real signature unknown
        pass

    def get_dock_item_by_name(self, *args, **kwargs): # real signature unknown
        pass

    def message(self, *args, **kwargs): # real signature unknown
        pass

    def remove_menus(self, *args, **kwargs): # real signature unknown
        pass

    def remove_menu_range(self, *args, **kwargs): # real signature unknown
        pass

    def set_contents(self, *args, **kwargs): # real signature unknown
        pass

    def set_menus(self, *args, **kwargs): # real signature unknown
        pass

    def set_statusbar(self, *args, **kwargs): # real signature unknown
        pass

    def set_statusbar_custom(self, *args, **kwargs): # real signature unknown
        pass

    def set_toolbar(self, *args, **kwargs): # real signature unknown
        pass
