...
class Entry(__gtk.Combo, __gtk.Editable):
    """
    Object GnomeEntry
    
    Signals from GnomeEntry:
      activate ()
    
    Properties from GnomeEntry:
      history-id -> gchararray: History ID
        History ID
      gtk-entry -> GtkEntry: GTK entry
        The GTK entry
    ...
    Signals from GObject:
      notify (GParam)
    """
    def append_history(self, *args, **kwargs): # real signature unknown
        pass

    def clear_history(self, *args, **kwargs): # real signature unknown
        pass

    def get_history_id(self, *args, **kwargs): # real signature unknown
        pass

    def get_max_saved(self, *args, **kwargs): # real signature unknown
        pass

    def gtk_entry(self, *args, **kwargs): # real signature unknown
        pass

    def prepend_history(self, *args, **kwargs): # real signature unknown
        pass

    def set_history_id(self, *args, **kwargs): # real signature unknown
        pass

    def set_max_saved(self, *args, **kwargs): # real signature unknown
        pass
