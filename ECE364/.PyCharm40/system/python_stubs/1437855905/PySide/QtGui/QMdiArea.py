...
class QMdiArea(QAbstractScrollArea):
    ...
    ActivationHistoryOrder = None # (!) real value is ''
    AreaOption = None # (!) real value is ''
    AreaOptions = None # (!) real value is ''
    CreationOrder = None # (!) real value is ''
    DontMaximizeSubWindowOnActivation = None # (!) real value is ''
    StackingOrder = None # (!) real value is ''
    staticMetaObject = None # (!) real value is ''
    SubWindowView = None # (!) real value is ''
    TabbedView = None # (!) real value is ''
