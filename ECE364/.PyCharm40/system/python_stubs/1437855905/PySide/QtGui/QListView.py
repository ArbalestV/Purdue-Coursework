...
class QListView(QAbstractItemView):
    ...
    Adjust = None # (!) real value is ''
    Batched = None # (!) real value is ''
    Fixed = None # (!) real value is ''
    Flow = None # (!) real value is ''
    Free = None # (!) real value is ''
    IconMode = None # (!) real value is ''
    LayoutMode = None # (!) real value is ''
    LeftToRight = None # (!) real value is ''
    ListMode = None # (!) real value is ''
    Movement = None # (!) real value is ''
    ResizeMode = None # (!) real value is ''
    SinglePass = None # (!) real value is ''
    Snap = None # (!) real value is ''
    Static = None # (!) real value is ''
