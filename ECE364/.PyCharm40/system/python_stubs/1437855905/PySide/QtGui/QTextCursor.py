...
class QTextCursor(__Shiboken.Object):
    ...
    BlockUnderCursor = None # (!) real value is ''
    Document = None # (!) real value is ''
    Down = None # (!) real value is ''
    End = None # (!) real value is ''
    EndOfBlock = None # (!) real value is ''
    EndOfLine = None # (!) real value is ''
    EndOfWord = None # (!) real value is ''
    KeepAnchor = None # (!) real value is ''
    Left = None # (!) real value is ''
    LineUnderCursor = None # (!) real value is ''
    MoveAnchor = None # (!) real value is ''
    MoveMode = None # (!) real value is ''
    MoveOperation = None # (!) real value is ''
    NextBlock = None # (!) real value is ''
    NextCell = None # (!) real value is ''
    NextCharacter = None # (!) real value is ''
    NextRow = None # (!) real value is ''
    NextWord = None # (!) real value is ''
    NoMove = None # (!) real value is ''
    PreviousBlock = None # (!) real value is ''
    PreviousCell = None # (!) real value is ''
    PreviousCharacter = None # (!) real value is ''
    PreviousRow = None # (!) real value is ''
    PreviousWord = None # (!) real value is ''
    Right = None # (!) real value is ''
    SelectionType = None # (!) real value is ''
    Start = None # (!) real value is ''
    StartOfBlock = None # (!) real value is ''
    StartOfLine = None # (!) real value is ''
    StartOfWord = None # (!) real value is ''
    Up = None # (!) real value is ''
    WordLeft = None # (!) real value is ''
    WordRight = None # (!) real value is ''
    WordUnderCursor = None # (!) real value is ''
    __hash__ = None
