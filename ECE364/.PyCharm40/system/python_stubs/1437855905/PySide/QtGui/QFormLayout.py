...
class QFormLayout(QLayout):
    ...
    AllNonFixedFieldsGrow = None # (!) real value is ''
    DontWrapRows = None # (!) real value is ''
    ExpandingFieldsGrow = None # (!) real value is ''
    FieldGrowthPolicy = None # (!) real value is ''
    FieldRole = None # (!) real value is ''
    FieldsStayAtSizeHint = None # (!) real value is ''
    ItemRole = None # (!) real value is ''
    LabelRole = None # (!) real value is ''
    RowWrapPolicy = None # (!) real value is ''
    SpanningRole = None # (!) real value is ''
    staticMetaObject = None # (!) real value is ''
    WrapAllRows = None # (!) real value is ''
    WrapLongRows = None # (!) real value is ''
