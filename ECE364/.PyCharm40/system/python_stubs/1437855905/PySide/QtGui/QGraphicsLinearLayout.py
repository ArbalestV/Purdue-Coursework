...
class QGraphicsLinearLayout(QGraphicsLayout):
    ...
    def itemSpacing(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setItemSpacing(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def stretchFactor(self, *args, **kwargs): # real signature unknown
        pass
