...
class QGraphicsView(QAbstractScrollArea):
    ...
    AnchorUnderMouse = None # (!) real value is ''
    AnchorViewCenter = None # (!) real value is ''
    BoundingRectViewportUpdate = None # (!) real value is ''
    CacheBackground = None # (!) real value is ''
    CacheMode = None # (!) real value is ''
    CacheModeFlag = None # (!) real value is ''
    CacheNone = None # (!) real value is ''
    DontAdjustForAntialiasing = None # (!) real value is ''
    DontClipPainter = None # (!) real value is ''
    DontSavePainterState = None # (!) real value is ''
    DragMode = None # (!) real value is ''
    FullViewportUpdate = None # (!) real value is ''
    IndirectPainting = None # (!) real value is ''
    MinimalViewportUpdate = None # (!) real value is ''
    NoAnchor = None # (!) real value is ''
    NoDrag = None # (!) real value is ''
    NoViewportUpdate = None # (!) real value is ''
    OptimizationFlag = None # (!) real value is ''
    OptimizationFlags = None # (!) real value is ''
    RubberBandDrag = None # (!) real value is ''
    ScrollHandDrag = None # (!) real value is ''
    SmartViewportUpdate = None # (!) real value is ''
