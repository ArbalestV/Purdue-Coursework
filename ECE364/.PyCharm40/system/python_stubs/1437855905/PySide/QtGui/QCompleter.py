...
class QCompleter(__PySide_QtCore.QObject):
    ...
    CaseInsensitivelySortedModel = None # (!) real value is ''
    CaseSensitivelySortedModel = None # (!) real value is ''
    CompletionMode = None # (!) real value is ''
    InlineCompletion = None # (!) real value is ''
    ModelSorting = None # (!) real value is ''
    PopupCompletion = None # (!) real value is ''
    staticMetaObject = None # (!) real value is ''
    UnfilteredPopupCompletion = None # (!) real value is ''
    UnsortedModel = None # (!) real value is ''
