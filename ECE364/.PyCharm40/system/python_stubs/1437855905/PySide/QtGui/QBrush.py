...
class QBrush(__Shiboken.Object):
    # no doc
    def color(self, *args, **kwargs): # real signature unknown
        pass

    def gradient(self, *args, **kwargs): # real signature unknown
        pass

    def isOpaque(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setTextureImage(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def textureImage(self, *args, **kwargs): # real signature unknown
        pass
