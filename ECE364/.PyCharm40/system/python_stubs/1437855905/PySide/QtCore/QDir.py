...
class QDir(__Shiboken.Object):
    ...
    AccessMask = None # (!) real value is ''
    AllDirs = None # (!) real value is ''
    AllEntries = None # (!) real value is ''
    CaseSensitive = None # (!) real value is ''
    Dirs = None # (!) real value is ''
    DirsFirst = None # (!) real value is ''
    DirsLast = None # (!) real value is ''
    Drives = None # (!) real value is ''
    Executable = None # (!) real value is ''
    Files = None # (!) real value is ''
    Filter = None # (!) real value is ''
    Filters = None # (!) real value is ''
    Hidden = None # (!) real value is ''
    IgnoreCase = None # (!) real value is ''
    LocaleAware = None # (!) real value is ''
    Modified = None # (!) real value is ''
    Name = None # (!) real value is ''
    NoDotAndDotDot = None # (!) real value is ''
    NoFilter = None # (!) real value is ''
    NoSort = None # (!) real value is ''
    NoSymLinks = None # (!) real value is ''
    PermissionMask = None # (!) real value is ''
    Readable = None # (!) real value is ''
    Reversed = None # (!) real value is ''
    Size = None # (!) real value is ''
    SortByMask = None # (!) real value is ''
    ...
    TypeMask = None # (!) real value is ''
    Unsorted = None # (!) real value is ''
    Writable = None # (!) real value is ''
    __hash__ = None
