...
class QXmlStreamReader(__Shiboken.Object):
    ...
    CustomError = None # (!) real value is ''
    DTD = None # (!) real value is ''
    EndDocument = None # (!) real value is ''
    EndElement = None # (!) real value is ''
    EntityReference = None # (!) real value is ''
    Error = None # (!) real value is ''
    ErrorOnUnexpectedElement = None # (!) real value is ''
    IncludeChildElements = None # (!) real value is ''
    Invalid = None # (!) real value is ''
    NoError = None # (!) real value is ''
    NoToken = None # (!) real value is ''
    NotWellFormedError = None # (!) real value is ''
    PrematureEndOfDocumentError = None # (!) real value is ''
    ProcessingInstruction = None # (!) real value is ''
    ReadElementTextBehaviour = None # (!) real value is ''
    SkipChildElements = None # (!) real value is ''
    StartDocument = None # (!) real value is ''
    StartElement = None # (!) real value is ''
    TokenType = None # (!) real value is ''
    UnexpectedElementError = None # (!) real value is ''
